import {
  ...
  MatListModule,
  MatNavList
} from "./chunk-BPJBKEJ7.js";
import {
  AuthGuard
} from "./chunk-MXM5TU3H.js";
import {
  HasRoleDirective,
  SharedModule
} from "./chunk-CJYPXICG.js";
import {
  MatExpansionModule,
  MatExpansionPanel,
  MatExpansionPanelHeader,
  MatExpansionPanelTitle
} from "./chunk-4DLZSESA.js";
import {
  KeycloakService,
  KeycloakService2
...
function SidebarComponent_mat_expansion_panel_60_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(28, "a", 23)(29, "mat-icon", 1);
    \u0275\u0275text(30, "smart_toy");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(31, "span", 2);
    \u0275\u0275text(32, "Automatisation");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(33, "a", 24)(34, "mat-icon", 1);
    \u0275\u0275text(35, "tune");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(36, "span", 2);
    \u0275\u0275text(37, "Configuration automatique");
    \u0275\u0275elementEnd()()()();
  }
}
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SidebarComponent, selectors: [["app-sidebar"]], decls: 61, vars: 4, consts: [["mat-list-item", "", "routerLink", "/dashboard", "routerLinkActive", "active"], ["matListItemIcon", ""], ["matListItemTitle", ""], ["mat-list-item", "", "routerLink", "/users", "routerLinkActive", "active", 4, "appHasRole"], ["mat-list-item", "", "routerLink", "/risks", "routerLinkActive", "active"], ["mat-list-item", "", "routerLink", "/controls", "routerLinkActive", "active"], ["mat-list-item", "", "routerLink", "/categories", "routerLinkActive", "active"], ["mat-list-item", "", "routerLink", "/assessments", "routerLinkActive", "active"], [1, "mat-elevation-z0"], ["expandedHeight", "48px", "collapsedHeight", "48px"], [1, "sidebar-menu-title"], [1, "sub-menu"], ["mat-list-item", "", "routerLink", "/compliance/frameworks", "routerLinkActive", "active"], ["mat-list-item", "", "routerLink", "/compliance/requirements", "routerLinkActive", "active"], ["mat-list-item", "", "routerLink", "/compliance/mappings", "routerLinkActive", "active"], ["mat-list-item", "", "routerLink", "/compliance/gap-analysis", "routerLinkActive", "active"], ["mat-list-item", "", "routerLink", "/remediation-plans", "routerLinkActive", "active"], ["class", "mat-elevation-z0", 4, "appHasRole"], ["mat-list-item", "", "routerLink", "/users", "routerLinkActive", "active"], ["mat-list-item", "", "routerLink", "/snmp", "routerLinkActive", "active"], ["mat-list-item", "", "routerLink", "/snmp/configs", "routerLinkActive", "active"], ["mat-list-item", "", "routerLink", "/snmp/run", "routerLinkActive", "active"], ["mat-list-item", "", "routerLink", "/snmp/results", "routerLinkActive", "active"], ["mat-list-item", "", "routerLink", "/snmp/automation", "routerLinkActive", "active"], ["mat-list-item", "", "routerLink", "/snmp/automation/config", "routerLinkActive", "active"]], template: function SidebarComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275elementEnd()()()();
        \u0275\u0275template(60, SidebarComponent_mat_expansion_panel_60_Template, 38, 0, "mat-expansion-panel", 17);
        \u0275\u0275elementEnd();
      }
      if (rf & 2) {
        \u0275\u0275advance(6);
...
var RoleGuard = class _RoleGuard {
  ...
  canActivate(route, state2) {
    console.group(`\u{1F6E1}\uFE0F [RoleGuard] V\xE9rification d'acc\xE8s pour: ${state2.url}`);
    if (!this.keycloakService.isLoggedIn()) {
      console.log("\u274C Utilisateur non connect\xE9, redirection vers login");
      console.log("\u{1F3AF} RETOUR: false (login requis)");
      console.groupEnd();
    ...
    console.log(`\u{1F464} Utilisateur: ${username}`);
    console.log(`\u{1F3F7}\uFE0F R\xF4les utilisateur: [${userRoles.join(", ")}]`);
    const requiredRoles = route.data["roles"];
    console.log(`\u{1F3AF} R\xF4les requis: [${requiredRoles?.join(", ") || "aucun"}]`);
    if (!requiredRoles || requiredRoles.length === 0) {
      console.log("\u2705 Aucun r\xF4le requis, acc\xE8s autoris\xE9");
      console.log("\u{1F3AF} RETOUR: true (pas de r\xF4le requis)");
      console.groupEnd();
      return true;
    }
    try {
      ...
      if (hasRequiredRole) {
        console.log(`\u2705 Acc\xE8s autoris\xE9 - utilisateur a un des r\xF4les requis`);
        console.log("\u{1F3AF} RETOUR: true (r\xF4le valide)");
        console.groupEnd();
        return true;
      }
      console.log(`\u274C Acc\xE8s refus\xE9 - r\xF4les insuffisants`);
      ...
      console.log("\u{1F3AF} RETOUR: UrlTree vers /unauthorized");
      console.groupEnd();
      return redirectUrl;
    } catch (error) {
      console.error("\u{1F4A5} Erreur lors de la v\xE9rification des r\xF4les:", error);
      const redirectUrl = this.router.createUrlTree(["/unauthorized"]);
      console.log("\u{1F3AF} RETOUR: UrlTree vers /unauthorized (erreur)");
      console.groupEnd();
      return redirectUrl;
    }
  }
  ...
  getRedirectUrlForRole() {
    console.log("\u26A0\uFE0F [RoleGuard] getRedirectUrlForRole() est d\xE9pr\xE9ci\xE9, redirection vers /unauthorized");
    return this.router.createUrlTree(["/unauthorized"]);
  }
  static {
    this.\u0275fac = function RoleGuard_Factory(t) {
      return new (t || _RoleGuard)(\u0275\u0275inject(KeycloakService2), \u0275\u0275inject(Router));
    };
  }
  static {
...
var routes = [
  {
    ...
    children: [
      ...
      {
        path: "dashboard",
        loadChildren: () => import("./chunk-ILYN22RO.js").then((m) => m.DashboardModule),
        canActivate: [AuthGuard, RoleGuard],
        data: { roles: ["admin", "risk_manager", "compliance_officer", "auditor", "user"] }
      },
      {
        path: "users",
        loadChildren: () => import("./chunk-JY4HUVM3.js").then((m) => m.UsersModule),
        canActivate: [AuthGuard, RoleGuard],
        data: { roles: ["admin"] }
      },
      {
        path: "risks",
        loadChildren: () => import("./chunk-VXE6MK6B.js").then((m) => m.RisksModule),
        canActivate: [AuthGuard, RoleGuard],
        data: { roles: ["admin", "risk_manager", "compliance_officer", "auditor", "user"] }
      },
      {
        path: "controls",
        loadChildren: () => import("./chunk-XVVYIN4T.js").then((m) => m.ControlsModule),
        canActivate: [AuthGuard, RoleGuard],
        data: { roles: ["admin", "risk_manager", "compliance_officer", "auditor", "user"] }
      },
      {
        path: "categories",
        loadChildren: () => import("./chunk-EQT4ZQKC.js").then((m) => m.CategoriesModule),
        canActivate: [AuthGuard, RoleGuard],
        data: { roles: ["admin", "risk_manager", "compliance_officer", "auditor", "user"] }
      },
      {
        path: "assessments",
        loadChildren: () => import("./chunk-BZYVKVNK.js").then((m) => m.AssessmentsModule),
        canActivate: [AuthGuard, RoleGuard],
        data: { roles: ["admin", "compliance_officer", "risk_manager", "auditor", "user"] }
      },
      {
        path: "compliance",
        loadChildren: () => import("./chunk-VSRDTJEJ.js").then((m) => m.ComplianceModule),
        canActivate: [AuthGuard, RoleGuard],
        data: { roles: ["admin", "compliance_officer", "risk_manager", "auditor", "user"] }
      },
      {
        path: "remediation-plans",
        loadChildren: () => import("./chunk-HAPRCOPR.js").then((m) => m.RemediationPlanModule),
        canActivate: [AuthGuard, RoleGuard],
        data: { roles: ["admin", "compliance_officer", "risk_manager", "auditor", "user"] }
      },
      {
        path: "snmp",
        loadChildren: () => import("./chunk-G654RREG.js").then((m) => m.SnmpModule),
        canActivate: [AuthGuard, RoleGuard],
...
//# sourceMappingURL=chunk-SSFN7CFY.js.map
