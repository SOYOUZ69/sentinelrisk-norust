import {
  LayoutModule,
  MatToolbarModule
} from "./chunk-Z5ACMMCX.js";
import "./chunk-L5K4OQEZ.js";
import {
  AuthGuard
...
var routes = [
  {
    path: "auth",
    loadChildren: () => import("./chunk-757FVO5V.js").then((m) => m.AuthModule)
  },
  {
    path: "unauthorized",
  ...
  },
  {
    ...
    loadChildren: () => {
      ...
      return import("./chunk-YKBY66WK.js").then((m) => {
  ...
  {
    path: "",
    loadChildren: () => import("./chunk-O75MIVWR.js").then((m) => m.LayoutModule),
    canActivate: [AuthGuard]
  },
  {
    path: "categories",
