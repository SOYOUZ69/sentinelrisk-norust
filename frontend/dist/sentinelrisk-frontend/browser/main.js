...
var routes = [
  {
    path: "auth",
    loadChildren: () => import("./chunk-YLRLMROH.js").then((m) => m.AuthModule)
  },
  {
    path: "remediation-plans",
    loadChildren: () => {
      console.debug("AppRoutingModule: Chargement du module RemediationPlan");
      return import("./chunk-VGJUNVUO.js").then((m) => {
  ...
  {
    path: "",
    loadChildren: () => import("./chunk-KVGYDXK3.js").then((m) => m.LayoutModule),
    canActivate: [AuthGuard]
  },
  {
    path: "categories",
