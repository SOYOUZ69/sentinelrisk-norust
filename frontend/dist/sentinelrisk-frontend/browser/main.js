import {
  LayoutModule,
  MatToolbarModule
} from "./chunk-SSFN7CFY.js";
import "./chunk-BPJBKEJ7.js";
import {
  AuthGuard
...
var routes = [
  {
    path: "auth",
    loadChildren: () => import("./chunk-7V6CRMVZ.js").then((m) => m.AuthModule)
  },
  {
    path: "unauthorized",
  ...
  },
  {
    ...
    loadChildren: () => {
      ...
      return import("./chunk-HAPRCOPR.js").then((m) => {
        console.debug("AppRoutingModule: Module RemediationPlan charg\xE9 avec succ\xE8s");
  ...
  {
    path: "",
    loadChildren: () => import("./chunk-UBOVRHGA.js").then((m) => m.LayoutModule),
    canActivate: [AuthGuard]
  },
  {
    path: "categories",
...
var AuthInterceptor = class _AuthInterceptor {
  ...
  static {
    this.\u0275fac = function AuthInterceptor_Factory(t) {
      return new (t || _AuthInterceptor)(\u0275\u0275inject(KeycloakService2));
    };
  }
  static {
...
var AuthInterceptor2 = class _AuthInterceptor {
  ...
  static {
    this.\u0275fac = function AuthInterceptor_Factory(t) {
      return new (t || _AuthInterceptor)(\u0275\u0275inject(KeycloakService2), \u0275\u0275inject(Router));
    };
  }
  static {
    this.\u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({ token: _AuthInterceptor, factory: _AuthInterceptor.\u0275fac });
