import {
  UserService
} from "./chunk-HLEZVPML.js";
import {
  MatDatepicker,
  MatDatepickerInput,
  MatDatepickerModule,
  MatDatepickerToggle
} from "./chunk-V3UCKD5E.js";
import {
  RiskService
} from "./chunk-KXFRHJZB.js";
import {
  MatPaginator,
  MatPaginatorModule,
  MatSort,
...
function AssessmentDetailComponent_mat_card_18_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275property("ngClass", "status-badge " + ctx_r0.assessment.status.toLowerCase());
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1("\xC9valuation #", ctx_r0.assessment.id, "");
    \u0275\u0275advance(2);
    \u0275\u0275property("ngClass", "status-pill " + ctx_r0.assessment.status.toLowerCase());
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r0.assessment.status, " ");
    \u0275\u0275advance(9);
    \u0275\u0275textInterpolate(ctx_r0.assessment.risk.name || "Non d\xE9fini");
    \u0275\u0275advance(5);
...
//# sourceMappingURL=chunk-BZYVKVNK.js.map
