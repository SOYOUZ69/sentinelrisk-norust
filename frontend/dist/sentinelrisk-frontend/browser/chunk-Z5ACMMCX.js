import {
  ...
  MatListModule,
  MatNavList
} from "./chunk-L5K4OQEZ.js";
import {
  AuthGuard
} from "./chunk-GWHKXM4I.js";
import {
  HasRoleDirective,
  SharedModule
} from "./chunk-74M4W3KO.js";
import {
  MatExpansionModule,
  MatExpansionPanel,
...
var routes = [
  {
    ...
    children: [
      ...
      {
        path: "dashboard",
        loadChildren: () => import("./chunk-ARILQUT3.js").then((m) => m.DashboardModule),
        canActivate: [AuthGuard, RoleGuard],
        data: { roles: ["admin", "risk_manager", "compliance_officer", "auditor", "user"] }
      },
      {
        path: "users",
        loadChildren: () => import("./chunk-ULHHU6IU.js").then((m) => m.UsersModule),
        canActivate: [AuthGuard, RoleGuard],
        data: { roles: ["admin"] }
      },
      {
        path: "risks",
        loadChildren: () => import("./chunk-CPG37WLD.js").then((m) => m.RisksModule),
        canActivate: [AuthGuard, RoleGuard],
        data: { roles: ["admin", "risk_manager", "compliance_officer", "auditor", "user"] }
      },
      {
        path: "controls",
        loadChildren: () => import("./chunk-DZQBDRTZ.js").then((m) => m.ControlsModule),
        canActivate: [AuthGuard, RoleGuard],
        data: { roles: ["admin", "risk_manager", "compliance_officer", "auditor", "user"] }
      },
      {
        path: "categories",
        loadChildren: () => import("./chunk-XSEH7X4J.js").then((m) => m.CategoriesModule),
        canActivate: [AuthGuard, RoleGuard],
        data: { roles: ["admin", "risk_manager", "compliance_officer", "auditor", "user"] }
      },
      {
        path: "assessments",
        loadChildren: () => import("./chunk-H5SEPXEL.js").then((m) => m.AssessmentsModule),
        canActivate: [AuthGuard, RoleGuard],
        data: { roles: ["admin", "compliance_officer", "risk_manager", "auditor", "user"] }
      },
      {
        path: "compliance",
        loadChildren: () => import("./chunk-GZE3FVX7.js").then((m) => m.ComplianceModule),
        canActivate: [AuthGuard, RoleGuard],
        data: { roles: ["admin", "compliance_officer", "risk_manager", "auditor", "user"] }
      },
      {
        path: "remediation-plans",
        loadChildren: () => import("./chunk-YKBY66WK.js").then((m) => m.RemediationPlanModule),
        canActivate: [AuthGuard, RoleGuard],
        data: { roles: ["admin", "compliance_officer", "risk_manager", "auditor", "user"] }
      },
      {
        path: "snmp",
        loadChildren: () => import("./chunk-4KVF7HEJ.js").then((m) => m.SnmpModule),
        canActivate: [AuthGuard, RoleGuard],
...
//# sourceMappingURL=chunk-Z5ACMMCX.js.map
