...
var KeycloakService2 = class _KeycloakService {
  ...
  hasRole(role) {
    ...
    console.debug(`[KeycloakService] V\xE9rification du r\xF4le: ${role} (normalis\xE9: ${roleLower})`);
    console.debug(`[KeycloakService] R\xF4les utilisateur: ${userRoles.join(", ")}`);
    ...
    console.debug(`[KeycloakService] R\xE9sultat final pour ${role}: ${hasRole}`);
    return hasRole;
  }
  hasAnyRole(roles) {
...
js-sha256/src/sha256.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-YZOLHLAY.js.map
