-- Migration V18 pour forcer la suppression et recréation de la table risk_status_history
-- Cette migration résout définitivement les problèmes d'incohérence
